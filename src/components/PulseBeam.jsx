...
const GradientColors = () => {
    return (
        <>
            <stop stopColor="#27AE60" stopOpacity="0"></stop>
            <stop stopColor="#27AE60"></stop>
            <stop offset="0.325" stopColor="#27AE60"></stop>
            <stop offset="1" stopColor="#27AE60" stopOpacity="0"></stop>
        </>
    );
};
